...
import IO;
import List;
import Set; // Importante para usar size() em conjuntos de vulnerabilidades
...
// ------------------------------------------------------------------
// 3. Main entry point (Correção do erro Undeclared variable: main)
// ------------------------------------------------------------------
...
void main(list[str] args) {
  ...
  // Cálculo de sumário usando funções de biblioteca robustas
