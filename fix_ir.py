content = """module lang::universal::IR
...
set[str] readsOf(UIRValue v) {
  switch (v) {
    ...
    case valPhi(list[tuple[UIRValue, str]] bs): return ( {} | it + readsOf(b[0]) | b <- bs );
    default: return {};
  }
}
"""

with open('src/lang/universal/IR.rsc', 'w', encoding='utf-8', newline='\n') as f:
    f.write(content)